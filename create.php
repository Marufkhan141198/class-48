...
<?php
   if(isset($_POST['submit'])){
    ...
    $query= "INSERT INTO students (Name, Class, Roll, Address) VALUES ('$name', '$class', '$roll','$address')";
...
<form action="" method="POST">
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" name="Name" value="" aria-describedby="emailHelp" required>
  </div>
  <div class="mb-3">
